...
def getLLMResponse(query, age_option, tasktype_option):
    ...
    new_prompt_template = FewShotPromptTemplate(
        ...
        input_variables=["template_userInput",
                         "template_ageoption", "template_tasktype_option"],
        example_separator="\n"
    )

    print(new_prompt_template.format(template_userInput=query,
          template_ageoption=age_option, template_tasktype_option=tasktype_option))

    # Recently langchain has recommended to use invoke function for the below please :)
    response = llm.invoke(new_prompt_template.format(template_userInput=query,
                          template_ageoption=age_option, template_tasktype_option=tasktype_option))
    print(response)
